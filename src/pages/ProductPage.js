      ...
      <div className="flex gap-[140px]">
        ...
        <div className="flex flex-col mt-3 mr-[140px] font-bold">
          ...
          <p className="p-2 text-[12px] font-light bg-[#FBEDCD]">
            This cake requires at least 3 lb(s). The price shown above is per lb
            in base options. The final price might change based on the options
            you choose.
          </p>
          ...
          <div>
            {productDesc && (
              <p className="text-[12px] max-w-[800px] font-light">
                ...
                this chocolatey delight raw or baked into a soft, gooey cookie.
              </p>
            )}
            {!productDesc && (
              <p className="text-[12px] max-w-[800px] font-light">
